...
# TODO: (Arduino Core Edit) Don't generate the bin and hex files, do it in platform.txt
...
#endif()
# For the block below this, the micro:bit target doesn't have a "post_process" command specified
# so we can ignore it, otherwise we might need to comment it out as well and add it to the 
# Arduino platform.txt file
# TODO: (end of Arduino Core Edit)
